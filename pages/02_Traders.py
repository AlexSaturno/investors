...
vectorstore_address = st.secrets["TESOURARIA_AZURESEARCH_VECTORSTORE_ADDRESS"]
vectorstore_key = st.secrets["TESOURARIA_AZURESEARCH_VECTORSTORE_KEY"]

TESOURARIA_AZURESEARCH_FIELDS_CHUNK_ID = "chunk_id"
TESOURARIA_AZURESEARCH_FIELDS_PARENT_ID = "parent_id"
TESOURARIA_AZURESEARCH_FIELDS_CHUNK = "chunk"
TESOURARIA_AZURESEARCH_FIELDS_TITLE = "title"
TESOURARIA_AZURESEARCH_FIELDS_TEXT_VECTOR = "text_vector"

AZURESEARCH_FIELDS_CHUNK_ID = st.secrets["TESOURARIA_AZURESEARCH_FIELDS_CHUNK_ID"]
AZURESEARCH_FIELDS_PARENT_ID = st.secrets["TESOURARIA_AZURESEARCH_FIELDS_PARENT_ID"]
AZURESEARCH_FIELDS_CHUNK = st.secrets["TESOURARIA_AZURESEARCH_FIELDS_CHUNK"]
AZURESEARCH_FIELDS_TITLE = st.secrets["TESOURARIA_AZURESEARCH_FIELDS_TITLE"]
AZURESEARCH_FIELDS_TEXT_VECTOR = st.secrets["TESOURARIA_AZURESEARCH_FIELDS_TEXT_VECTOR"]
...
vector_store: AzureSearch = AzureSearch(
    ...
    index_name=st.secrets["TESOURARIA_AZURESEARCH_INDEX_NAME"],
...
################################################################################################################################
def main():
    st.subheader("Traders", divider=True)
    chain_key = "chain_traders"
    memory_key = "memory_traders"
